...
class Innercontoh {
    ...
    public Innercontoh(String nama, int sks, String nilai){
        this.nama = nama;
        this.sks = sks;
        this.nilai = nilai;
...
public class contoh {
    public static void main(String[] args) {
        ...
        ArrayList<Innercontoh> daftarMataKuliah = new ArrayList<>();
        ...
        while (true) {
            ...
            daftarMataKuliah.add(new Innercontoh(namaMataKuliah, sks ,nilai));
        }
        int totalSKS = 0;
        double totalNilai = 0;
        ...
        System.out.println("----------------------------------------------------------------");
        for (Innercontoh mk : daftarMataKuliah) {
